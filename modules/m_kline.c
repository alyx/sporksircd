...
DECLARE_MODULE_AV1(kline, modinit, modfini, kline_clist, NULL, NULL, "SporksIRCD development team");
...
modinit(void)
{
	add_capability("KLN", CAP_KLN, YES, NO);
	add_capability("UNKLN", CAP_UNKLN, YES, NO);
	return 0;
}
