...
typedef struct
{
	...
	unsigned int cmd;	/* Command associated */
	const void *data;	/* Opaque data */
	int approved;
} hook_data_channel;
...
typedef struct
{
	...
	struct Client *target;
	unsigned int cmd;	/* Command assocated */
