...
DECLARE_MODULE_AV1(who, NULL, NULL, who_clist, NULL, NULL, "SporksIRCD development team");

static void do_who_on_channel(struct Client *source_p, struct Channel *chptr,
			      int server_oper, int member,
			      struct who_format *fmt);

static void who_global(struct Client *source_p, const char *mask, int server_oper, bool operspy, struct who_format *fmt);
 ...
 */
static void
who_global(struct Client *source_p, const char *mask, int server_oper, bool operspy, struct who_format *fmt)
{
	struct membership *msptr;
	struct Client *target_p;
