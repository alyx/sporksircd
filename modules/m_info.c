...
DECLARE_MODULE_AV1(info, NULL, NULL, info_clist, info_hlist, NULL, "SporksIRCD development team");
...
/* *INDENT-OFF* */
/* XXX make this hookable by modules */
static struct InfoStruct info_table[] = {
	...
	{
		"founder_on_channel_create",
		OUTPUT_BOOLEAN_YN,
		&ConfigChannel.founder_on_channel_create,
		"Give users +uo on channel create",
	},
	{
	...
	},
	{
		"use_founder",
		OUTPUT_BOOLEAN_YN,
		&ConfigChannel.use_founder,
		"Enable chanmode +u (founder)",
	},
	{
		"use_except",
		OUTPUT_BOOLEAN_YN,
