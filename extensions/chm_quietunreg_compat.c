...
DECLARE_MODULE_AV1(chm_quietunreg_compat, _modinit, _moddeinit, NULL, NULL, NULL, "SporksIRCD development team");
...
_modinit(void)
{
	...
	chmode_table['R'].isupport_type = ISUPPORT_D;
...
_moddeinit(void)
{
	...
	chmode_table['R'].mode_type = 0;
	chmode_table['R'].isupport_type = ISUPPORT_INVALID;
}
	...
	const char **parv, int *errors, int dir, char c, long mode_type)
{
	...
	if (MyClient(source_p))
		chm_list(source_p, chptr, alevel, 1, &newparn, newparv,
