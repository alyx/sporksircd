...
DECLARE_MODULE_AV1(resv, NULL, NULL, resv_clist, NULL, NULL, "SporksIRCD development team");
...
static void remove_resv(struct Client *source_p, const char *name, bool propagated);
 ...
 */
static void
parse_resv(struct Client *source_p, const char *name, const char *reason, int temp_time, bool propagated)
{
...
static void
remove_resv(struct Client *source_p, const char *name, bool propagated)
{
