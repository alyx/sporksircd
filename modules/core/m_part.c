...
DECLARE_MODULE_AV1(part, NULL, NULL, part_clist, NULL, NULL, "SporksIRCD development team");

extern int h_channel_part;
...
part_one_client(struct Client *client_p, struct Client *source_p, char *name, char *reason)
{
	...
	char *reason2 = LOCAL_COPY(reason);
	...
	cansend = can_send(chptr, source_p, msptr, reason2, COMMAND_PART);
