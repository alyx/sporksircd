...
\command{ACCEPT} \userliteral{nick}\literal{,-{}}\userliteral{nick}\literal{,} \userliteral{...}
...
\command{CNOTICE} \userliteral{nick} \userliteral{channel} \literal{:}\userliteral{text}
...
\subsubsection{FSAY}
\command{FSAY} \userliteral{channel} \userliteral{nick} \literal{:} \userliteral{message}
...
\command{FACTION} \userliteral{channel} \userliteral{nick} \literal{:} \userliteral{message}
...
\command{FINDFORWARDS} \userliteral{channel}
...
\subsection{HELP}
	\command{HELP} [\userliteral{topic}]
...
\subsection{IDENTIFY}
	\command{IDENTIFY} \userliteral{parameters...}
