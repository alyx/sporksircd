/*
 * Deny user to remove +i flag unless they are irc operators
 *
...
DECLARE_MODULE_AV1(force_user_invis, NULL, NULL, NULL, NULL, noi_hfnlist, "SporksIRCD development team");
