...
DECLARE_MODULE_AV1(nick, modinit, modfini, nick_clist, NULL, NULL, "SporksIRCD development team");
...
modinit(void)
{
	add_capability("SAVE", CAP_SAVE, YES, NO);
	add_capability("EUID", CAP_EUID, YES, NO);
	return 0;
}
...
modfini(void)
{
	delete_capability("SAVE");
	delete_capability("EUID");
}
