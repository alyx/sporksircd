...
DECLARE_MODULE_AV1(chm_operonly_compat, _modinit, _moddeinit, NULL, NULL, NULL, "SporksIRCD development team");
...
_modinit(void)
{
	...
	chmode_table['O'].isupport_type = ISUPPORT_D;
...
_moddeinit(void)
{
	...
	chmode_table['O'].mode_type = 0;
	chmode_table['O'].isupport_type = ISUPPORT_INVALID;
}
