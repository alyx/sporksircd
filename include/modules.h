...
#else
# define DECLARE_MODULE_AV1(name,reg,unreg,cl,hl,hfnlist, v) \
	struct mapi_mheader_av1 _m name ## _mheader = { MAPI_V1, reg, unreg, cl, hl, hfnlist, v}
...
extern int unload_one_module(const char *, bool);
extern int load_one_module(const char *, bool);
extern int load_a_module(const char *, bool, int);
