...
DECLARE_MODULE_AV1(challenge, challenge_load, NULL, NULL, NULL, NULL, "SporksIRCD development team");
#else
...
DECLARE_MODULE_AV1(challenge, NULL, NULL, challenge_clist, NULL, NULL, "SporksIRCD development team");
...
m_challenge(struct Client *client_p, struct Client *source_p, int parc, const char *parv[])
{
	...
	if(*parv[1] == '+')
	{
		...
		/* This is here to avoid relying on undefined behaviour. --Elizabeth */
		parv[1]++;
