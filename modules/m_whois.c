...
static void single_whois(struct Client *source_p, struct Client *target_p, bool operspy);
...
DECLARE_MODULE_AV1(whois, NULL, NULL, whois_clist, whois_hlist, NULL, "SporksIRCD development team");
 ...
 */
static void
single_whois(struct Client *source_p, struct Client *target_p, bool operspy)
{
	char buf[BUFSIZE];
	rb_dlink_node *ptr;
